...
export class WhatsappChatEventGateway {
  constructor(
    private readonly whatsappChatEventService: WhatsappChatEventService,
  ) {}

  @SubscribeMessage('createWhatsappChatEvent')
  create(
    @MessageBody() createWhatsappChatEventDto: CreateWhatsappChatEventDto,
  ) {
  ...
  update(
    @MessageBody() updateWhatsappChatEventDto: UpdateWhatsappChatEventDto,
  ) {
