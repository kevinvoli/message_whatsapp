...
@Module({
  imports: [
    ...
    WhatsappChatParticipantModule,
    WhatsappChatEventModule,
    WhatsappMessageModule,
    WhatsappMessageContentModule,
    WhatsappTextContentModule,
    WhatsappMediaContentModule,
    WhatsappInteractiveContentModule,
    WhatsappMessageEventModule,
    WhatsappMessageReactionModule,
    WhatsappMessageContextModule,
    WhatsappConversationModule,
    WhatsappAgentModule,
    WhatsappCustomerModule,
    WhatsappContactsModule,
    WhatsappStatusesModule,
    WhatsappMediaModule,
    WhatsappLocationContentModule,
