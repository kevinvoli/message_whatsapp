...
@Module({
  imports: [
    TypeOrmModule.forFeature([PendingMessage, QueuePosition, WhatsappCommercial,WhatsappConversation, WhatsappMessage, WhatsappChat]),
    forwardRef(() => WhatsappMessageModule),
  ],
  controllers: [],
  providers: [DispatcherService,UsersService ,QueueService,WhatsappConversationService,WhatsappMessageService,WhatsappChatService,CommunicationWhapiService,],
