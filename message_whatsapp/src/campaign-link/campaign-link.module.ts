...
import { CampaignLinkController, CampaignTrackingController, CampaignShortLinkController } from './campaign-link.controller';
...
@Module({
  ...
  controllers: [CampaignLinkController, CampaignTrackingController, CampaignShortLinkController],
