...
// ─── Serveur -> Commercial / Admin : pauses decalees ─────────────────────────
export const BREAK_EVENTS = {
  BREAK_PROMPT:          'break:prompt',
  BREAK_PROMPT_CLEAR:    'break:prompt_clear',
  BREAK_DISCONNECT_ALERT:'break:disconnect_alert',
} as const;
export type BreakEvent = typeof BREAK_EVENTS[keyof typeof BREAK_EVENTS];
