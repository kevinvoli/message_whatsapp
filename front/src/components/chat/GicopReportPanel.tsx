...
import { CheckCircle, ChevronDown, ChevronUp, ClipboardList, Phone, Plus, Star, Trash2, X } from 'lucide-react';
        ...
        <div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-1.5">
              <input type="text" placeholder="Libellé (ex: Commande, Domicile)"
                value={newPhoneLabel}
