...
- **Store d'État** : Utilisation de Zustand pour le panel d'administration afin de centraliser l'état global et assurer une source de vérité unique côté client.
