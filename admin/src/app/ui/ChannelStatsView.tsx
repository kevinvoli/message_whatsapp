...
import { getStatutChannelsFiltered, getChannelDetailStats } from '@/app/lib/api/metrics.api';
import { getChannels } from '@/app/lib/api/channels.api';
import { getCampaignLinks } from '@/app/lib/api/campaign-link.api';
...
function ProviderBadgeLocal({ provider }: { provider?: ProviderType | null }) {
                    ...
                    {filteredChannels.map((stat) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <ProviderBadgeLocal provider={detail?.provider} />
                          </td>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="sm:col-span-1">
                ...
                <select
                  ...
                  onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSelectedChannelId(e.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDetailDateFrom(e.target.value)}
                  className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  max={today}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDetailDateTo(e.target.value)}
                  className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
            ...
            {selectedChannelDetail && (
              <div className="mt-4 flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100">
                <ProviderBadgeLocal provider={selectedChannelDetail.provider} />
