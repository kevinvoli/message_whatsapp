...
import { getStoredMedias, getGalerieFilterOptions } from '@/app/lib/api/galerie-media.api';
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setSort(e.target.value.substring(0, idx));
              setOrder(e.target.value.substring(idx + 1) as 'asc' | 'desc');
              resetPage();
            }}
