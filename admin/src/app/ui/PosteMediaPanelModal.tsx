...
import { getPostePanelConfig, updatePostePanelConfig } from '@/app/lib/api';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-md rounded-xl bg-white shadow-2xl">
        ...
        <div className="flex justify-end gap-3 border-t border-gray-200 px-5 py-4">
          ...
          <button onClick={handleSave} disabled={saving || loading} className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-60">
